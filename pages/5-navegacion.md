---
title: Navegación
description: Tabla de contenidos, navegación inteligente, búsqueda difusa y estándar. Además aprende a cómo crear items en el menú.
layout: libdoc_page.liquid
permalink: /pages/5-navegacion/index.html
eleventyNavigation:
    key: Navegación
    order: 5
tags:
...
2. [Entrada de búsqueda](./5_2-busqueda.md)
3. [Resultados de búsqueda](./5_3-resultadosBusqueda.md)
4. [Links personalizados](./5_4-linksPersonalizados.md)
5. [Lista de tags](./5_5-listaTags.md)
6. [Tabla de contenidos](./5_6-tablaContenidos.md)